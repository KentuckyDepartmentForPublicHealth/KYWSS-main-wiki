...
After installing [system requirements](software_install_README.qmd) and [setting up your environment](setting-up-environment.qmd), you will be able to run `WW_data_pipeline.py`
